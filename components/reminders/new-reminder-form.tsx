...
const initialValues: NewReminderValues = {
  title: "",
  message: "",
  mode: "single",
  selectedDates: [],
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-3 rounded-lg border border-border/70 bg-muted/20 p-3">
                    <label className="flex cursor-pointer items-center gap-3">
                      <Checkbox
                        checked={values.channels.whatsapp}
                        onCheckedChange={(checked) =>
                          setFieldValue("channels.whatsapp", Boolean(checked))
                        }
                      />
                    ...
                    <label className="flex cursor-pointer items-center gap-3">
                      <Checkbox
                        checked={values.channels.sms}
                        onCheckedChange={(checked) =>
                          setFieldValue("channels.sms", Boolean(checked))
                        }
                      />
                      <span className="text-sm">
                        SMS
                    ...
                    <label className="flex cursor-pointer items-center gap-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setFieldValue("channels.email", Boolean(checked))
                        }
                      />
                      <span className="text-sm">
                        E-mail
                  ...
                  {touched.channels && typeof errors.channels === "string" && (
